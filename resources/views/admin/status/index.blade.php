        ...
        >
            ...
            @foreach($data as $item)
                <tr>
                    ...
                    <td><a dusk="excluir{{$item->id}}" class="btn btn-danger" href="{{route('status.delete', [$item->id])}}">Excluir</a></td>
                    <td><a dusk="editar{{$item->id}}" class="btn btn-success" href="{{route('status.edit', [$item->id])}}">Editar</a></td>
                </tr>
            @endforeach
            </tbody>
        </table>
